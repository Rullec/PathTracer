...
tMatrix cBaseCamera::GetViewMat() { return mViewTrans; }

tMatrix cBaseCamera::GetProjMat() { return mProjTrans; }
...
tVector cBaseCamera::GetCameraPos() { return mCameraPos; }

tVector cBaseCamera::GetCameraFront() { return mCameraFront; }

void cBaseCamera::GetCameraScene(int &width, int &height, double &fov,
                                 double &near)
{
    width = mWindowWidth;
...
void cBaseCamera::Reload()
{
    ...
    // calculate projection
    {
        glm::mat4 projection = glm::perspective(
            glm::radians(mFOV), mWindowWidth / mWindowHeight, mNear, mFar);
