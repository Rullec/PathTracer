...
public:
    ...
    virtual tVector evaluate(const tVector &wi, const tVector &wo,
                             const tVector &normal) = 0;
    virtual tVector
    Sample_Li(const std::vector<std::shared_ptr<cLight>> &lights,
              cAccelStruct *mAccelStruct, const tVector &ref_normal,
              const tVector &ref_point, const tRay &wo_ray);
    virtual tVector Sample_f(const tVector &ref_normal, const tVector &wo,
                             tVector &wi_dir) = 0;
...
class cBRDF : public cBxDF
{
    // diffuse + specular
public:
    cBRDF(const tVector &ka, const tVector &kd, const double &ns,
          const tVector &ks);
    ...
    virtual tVector evaluate(const tVector &wi, const tVector &wo,
                             const tVector &normal) override;
    virtual tVector Sample_f(const tVector &ref_normal, const tVector &wo,
                             tVector &wi_dir) override;
...
{
public:
    cBSDF(const tVector &ka, const tVector &kd, const double &ni,
